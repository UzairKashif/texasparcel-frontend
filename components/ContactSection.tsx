            ...
            <div className="bg-white p-8 rounded-lg shadow-md mb-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  <Phone size={20} className="text-green-700 mr-4 mt-1" />
                  <div>
                ...
                <div className="flex items-start">
                  <Mail size={20} className="text-green-700 mr-4 mt-1" />
                  <div>
                    <h4 className="font-medium text-gray-700">Email</h4>
                    <p className="text-gray-600">info@landportal.com</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <MapPin size={20} className="text-green-700 mr-4 mt-1" />
                  <div>
                ...
                <div className="flex items-start">
                  <Clock size={20} className="text-green-700 mr-4 mt-1" />
                  <div>
